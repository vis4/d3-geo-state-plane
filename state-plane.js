d3.geo.statePlane = (function() {
    ...
    var statePlaneDef = {
        ...
        "AL": { "proj": "tmerc", "rotate": [85.83333, -30.5], "bounds": [[-0.039122,-0.079084],[0.013939,0.004511]] },
        // ESRI:102006 - http://spatialreference.org/ref/esri/102006/
        "AK": { "proj": "albers", "rotate": [160, 0, -35], "parallels": [55, 65], "bounds": [[0.239549,-0.48059],[0.801862,-0.198652]] },
    ...
    return function(state, width, height) {
        ...
        if (statePlaneDef[state]) {
            ...
            var proj = d3.geo[prj[def.proj] || def.proj]();
